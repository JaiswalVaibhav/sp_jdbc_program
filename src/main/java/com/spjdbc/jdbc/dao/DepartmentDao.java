...
import com.spjdbc.jdbc.repository.DepartmentRepo;
...
public class DepartmentDao implements DepartmentRepo {
    ...
    @Override
    public String addDeptAndEmp(Department department) {
        ...
        for (Employee e:department.getEmployeeList()) {
            String sql2 = "insert into employee(name,city,dept_id) values (?,?,?)";
            jdbcTemplate.update(sql2, new Object[]{e.getName(),e.getCity(),newUserId});
        }
